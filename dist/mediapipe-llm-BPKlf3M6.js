...
function Oe(e, t) {
  e: {
    for (var r = ['CLOSURE_FLAGS'], n = ne, i = 0; i < r.length; i++)
      if ((n = n[r[i]]) == null) {
        r = null;
        break e;
      }
...
var ye,
  _r = Oe(610401301, !1),
  fn = Oe(645172343, Oe(1, !0)),
  dn = Oe(660014094, !1);
const Lt = ne.navigator;
function ot(e) {
  return (
    !!_r && !!ye && ye.brands.some(({ brand: t }) => t && t.indexOf(e) != -1)
  );
}
function N(e) {
  var t;
  return (
    ((t = ne.navigator) && (t = t.userAgent)) || (t = ''), t.indexOf(e) != -1
  );
}
function q() {
...
function Je() {
  return q()
    ? ot('Chromium')
    : ((N('Chrome') || N('CriOS')) && !(!q() && N('Edge'))) || N('Silk');
}
...
var br = typeof Uint8Array < 'u',
  wr = !pn && typeof btoa == 'function';
function kt(e) {
  if (!wr) {
    var t;
    t === void 0 && (t = 0), vr(), (t = yr[t]);
    var r = Array(Math.floor(e.length / 3)),
      n = t[64] || '';
    let a = 0,
      l = 0;
  ...
  for (t = '', r = 0, n = e.length - 10240; r < n; )
    t += String.fromCharCode.apply(null, e.subarray(r, (r += 10240)));
...
var Y = class {
  constructor(e, t) {
    if ((Sr(t), (this.i = e), e != null && e.length === 0))
    ...
    : (e, t) => {
        e.i !== void 0
          ...
          : Object.defineProperties(e, {
              i: { value: t, configurable: !0, writable: !0, enumerable: !1 },
            });
      },
  Bt = se
    ? (e, t) => {
...
function Ge(e) {
  if (e.length < 16) ie(Number(e));
    ...
    (e = BigInt(e)),
      (y = Number(e & BigInt(4294967295)) >>> 0),
      (b = Number((e >> BigInt(32)) & BigInt(4294967295)));
  else {
    const t = +(e[0] === '-');
    b = y = 0;
    const r = e.length;
    for (let n = t, i = ((r - t) % 6) + t; i <= r; n = i, i += 6) {
      ...
      (b *= 1e6),
        (y = 1e6 * y + o),
        y >= 4294967296 &&
          ((b += Math.trunc(y / 4294967296)), (b >>>= 0), (y >>>= 0));
    }
    if (t) {
      const [n, i] = vt(y, b);
      (y = n), (b = i);
...
const Tn = Number.MIN_SAFE_INTEGER.toString(),
  Pn = bt ? BigInt(Number.MIN_SAFE_INTEGER) : void 0,
  In = Number.MAX_SAFE_INTEGER.toString(),
  On = bt ? BigInt(Number.MAX_SAFE_INTEGER) : void 0;
function Mt(e, t) {
...
function Rt(e) {
  return (
    e[0] !== '-' &&
    (e.length < 20 || (e.length === 20 && Number(e.substring(0, 6)) < 184467))
  );
}
function kn(e) {
  if (e == null) return e;
  ...
  if (Pr(e)) {
    ...
    if (t === 'number')
      return (e = Math.trunc(e)) >= 0 && Number.isSafeInteger(e)
        ? e
        : (function (r) {
            if (r < 0) {
              ie(r);
...
function kr(e) {
  ...
  return (t = he)
    ? ((function (r, n) {
        (Ue ||= /* @__PURE__ */ new WeakMap()).set(r, n),
          (xr ||= /* @__PURE__ */ new WeakMap()).set(n, r);
      })(e, (t = new t(e, { set: (r, n, i) => (Le(), (r[n] = i), !0) }))),
      t)
    : e;
}
...
function Ur(e, t, r) {
  if ((e == null && (e = Be), (Be = void 0), e == null)) {
    ...
    e: {
      ...
      if (t) {
        if ((t = Math.max(t, i - (+!!(512 & n) - 1))) > 1024)
          throw Error('spvt');
        n = (-16760833 & n) | ((1023 & t) << 14);
      }
    }
...
function Br(e, t, r, n, i) {
  if (e != null) {
    if (Array.isArray(e))
      e = ke(e) ? void 0 : i && 2 & L(e) ? e : ze(e, t, r, n !== void 0, i);
    else if (yt(e)) {
      const o = {};
  ...
  return e.M === Ce
    ...
    : (function (t) {
        switch (typeof t) {
          ...
          case 'bigint':
            return (
              bt ? t >= Pn && t <= On : t[0] === '-' ? Mt(t, Tn) : Mt(t, In)
            )
              ? Number(t)
              : String(t);
          case 'boolean':
...
function jr(e, t, r = st) {
  if (e != null) {
    ...
    if (Array.isArray(e)) {
      ...
      return 2 & n
        ? e
        : ((t &&= n === 0 || (!!(32 & n) && !(64 & n || !(16 & n)))),
          t ? (v(e, -12293 & (34 | n)), e) : ze(e, jr, 4 & n ? st : r, !0, !0));
    }
    return (
      e.M === Ce && ((r = e.m), (e = 2 & (n = k(r)) ? e : Fr(e, r, n, !0))), e
    );
  }
}
function Fr(e, t, r, n) {
...
function Vt(e, t, r, n) {
  if (!((t = n + (+!!(512 & t) - 1)) < 0 || t >= e.length || t >= r))
    return e[t];
}
function le(e, t, r, n) {
  if (r === -1) return null;
  ...
  if (!(r >= i)) {
    var o = e.length;
    return n && 256 & t && (n = e[o - 1][r]) != null
      ? (Vt(e, t, i, r) &&
          Ze != null &&
          ((t = (e = vn ??= {})[Ze] || 0) >= 4 || ((e[Ze] = t + 1), Le())),
        n)
      : Vt(e, t, i, r);
  }
...
function T(e, t, r, n, i) {
  ...
  return (
    (e[r + (+!!(512 & t) - 1)] = n),
    256 & t && r in (e = e[e.length - 1]) && delete e[r],
    t
  );
}
function Vr(e, t, r) {
...
function ut(e, t, r) {
  var n = e.m,
    ...
    o = le(n, i, r, !1);
  return (
    (t = Lr(o, t, i)) !== o && t != null && T(n, i, r, t, !1),
    (n = t) == null ||
      ((e = e.m),
      2 & (i = k(e)) || ((o = Dr(n)) !== n && T(e, i, r, (n = o), !1))),
    n
  );
}
function J(e, t, r) {
...
function me(e, t, r, n) {
  ...
  u === 1 || (u === 4 && 32 & a)
    ? G(a) ||
      ((t = a),
      (a |= !s.length || (16 & a && (!l || 32 & a)) ? 2 : 2048) !== t &&
        v(s, a),
      Object.freeze(s))
    : ((l = u === 5 && (!!(32 & a) || G(a) || !!Ue?.get(s))),
      (u === 2 || l) &&
        G(a) &&
        ((s = $(s)),
        (a = oe((a = te(a, i)), i, !0)),
        v(s, a),
        (i = T(e, i, t, s))),
      G(a) || ((t = a), (a = oe(a, i, !0)) !== t && v(s, a)),
      l && (o = kr(s))),
    (o = o || s),
    (r = n ?? new r()),
    o.push(r),
    2 & L(r.m) ? Bt(o, 8) : Bt(o, 16);
}
function lt(e) {
  return e ?? 0;
}
...
function Gr(e, t, r) {
  {
    ...
    if ((ae(a), r == null)) T(u, a, t);
      ...
      var n,
        i = L(r),
        o = i,
        s = !!(2 & i) || Object.isFrozen(r);
      if (((n = !s) && (n = An === void 0 || !1), Mr(e, i)))
        for (
          i = 21,
            s && ((r = $(r)), (o = 0), (i = oe((i = te(i, a)), a, !0))),
            e = 0;
          e < r.length;
          e++
        )
          r[e] = Ir(r[e]);
      n && ((r = $(r)), (o = 0), (i = oe((i = te(i, a)), a, !0))),
        i !== o && v(r, i),
        T(u, a, t, r);
    }
  }
...
function m(e, t, r) {
  ...
  let u = L(o);
  if (
    (u === 0 && s && !i ? ((u |= 33), v(o, u)) : 1 & u || ((u |= 1), v(o, u)),
    i
      ? (2 & u || Er(o, 34), Object.freeze(o))
      : (2 & u || 2048 & u) &&
        ((o = $(o)), (i = 1), s && (i |= 32), v(o, i), T(e, n, t, o)),
    typeof r != 'string')
  )
    throw Error();
  o.push(r);
...
function zt(e) {
  ...
  if (e.constructor === ArrayBuffer)
    return { buffer: new Uint8Array(e), B: !1 };
  if (e.constructor === Y) {
    Sr(be);
    var t = e.i;
    return {
      buffer:
        ((t = t == null || ve(t) ? t : typeof t == 'string' ? Ut(t) : null) ==
        null
          ? t
...
function zr(e) {
  e = Ne ? e.m : ze(e.m, Nr, void 0, void 0, !1);
  {
    ...
    if (l) {
      ...
      for (
        ;
        l > 0 && ((u = i[l - 1]) == null || ke(u) || (Nt(u) && u.size === 0));
        l--
      )
        var a = !0;
      (i !== e || o || a) &&
        (t
          ? (a || o || s) && (i.length = l)
          : (i = Array.prototype.slice.call(i, 0, l)),
        s && i.push(s)),
        (a = i);
    } else a = e;
  }
...
function We(e) {
  ...
  for (u = 1; o !== void 0; ) {
    ...
    let p = u + 1;
    for (
      typeof (o = e[++i]) == 'number' && o < 0 && ((p -= o), (o = e[++i]));
      u < p;
      u++
    ) {
      var c = s[u];
...
function Hr(e, t, r) {
  (t =
    t == null || typeof t == 'boolean'
      ...
      : typeof t == 'number'
        ? !!t
        : void 0) != null && (M(e.i, 8 * r), e.i.i.push(t ? 1 : 0));
}
function Tt(e, t, r) {
  (t = Or(t)) != null && De(e, r, gr(t));
}
function He(e, t, r, n, i) {
  (t = t instanceof w ? t.m : Array.isArray(t) ? Ur(t, n[0], n[1]) : void 0) !=
    null && ((r = wt(e, r)), i(t, e), St(e, r));
}
function Kr(e, t, r) {
...
var B,
  ct = x(function (e, t, r) {
    (t = Tr(t)) != null &&
      (M(e.i, 8 * r + 5),
      (e = e.i),
      (r = En ||= new DataView(new ArrayBuffer(8))).setFloat32(0, +t, !0),
      (b = 0),
      (t = y = r.getUint32(0, !0)),
      e.i.push((t >>> 0) & 255),
      e.i.push((t >>> 8) & 255),
  ...
  tt = x(function (e, t, r) {
    (t = (function (n) {
      ...
      if (Pr(n)) {
        if (i === 'string') {
          if (((i = Math.trunc(Number(n))), Number.isSafeInteger(i)))
            n = String(i);
          else if (
            ((i = n.indexOf('.')) !== -1 && (n = n.substring(0, i)),
            !(n[0] === '-'
              ? n.length < 20 ||
                (n.length === 20 && Number(n.substring(0, 7)) > -922337)
              : n.length < 19 ||
                (n.length === 19 && Number(n.substring(0, 6)) < 922337)))
          )
            if ((Ge(n), (n = y), 2147483648 & (i = b)))
              if (mt())
      ...
      t != null &&
        (typeof t == 'string' && Ht(t),
        t != null &&
          (M(e.i, 8 * r),
          typeof t == 'number'
            ? ((e = e.i), ie(t), je(e, y, b))
            : ((r = Ht(t)), je(e.i, r.j, r.i))));
  }),
  Rn = x(function (e, t, r) {
    (t = kn(t)) != null &&
      (typeof t == 'string' && $t(t),
      t != null &&
        ...
        typeof t == 'number'
          ? ((e = e.i), ie(t), je(e, y, b))
          : ((r = $t(t)), je(e.i, r.j, r.i))));
  }),
  ee = x(Et),
  Me = new R(function (e, t, r) {
...
function rt(e, t) {
  if (t != null)
    if (Array.isArray(t)) K(e, 2, ze(t, Nr, void 0, void 0, !1));
    else {
      if (!(typeof t == 'string' || t instanceof Y || ve(t)))
        throw Error(
...
var re = class extends w {
  ...
  Xt = [
    ...
    x(function (e, t, r) {
      ...
      (t =
        t == null || typeof t == 'string' || ve(t) || t instanceof Y
          ? t
          : void 0) != null && De(e, r, zt(t).buffer);
    }),
  ],
  zn = [
    0,
    ...
    [
      ...
      [0],
      V,
      [0, j, I, j, ge, -1, Yr, I, -1, [0, j, -1], ge, j],
      V,
      [0, I, -2],
      V,
      [0, ee, j, 1, j, -3],
    ...
    [0, I],
    j,
    [0, [1, 3], [2, 4], V, [0, Me], -1, V, [0, U], -1, B, [0, I, -1]],
    I,
  ],
  Pt = {},
  $n = (Pt.C = {});
...
var Zt = class extends w {
  ...
  Qt = [0, tt, -1, S, -3, tt, Me, O, g, tt, -1, S, g, S, -2, O],
  C = class extends w {
    constructor(e) {
      super(e, 500);
    }
          ...
          e.videoWidth !== void 0
            ...
            : e.naturalWidth !== void 0
              ...
              : e.displayWidth !== void 0
                ...
                : [e.width, e.height];
        !this.l ||
          (o === this.h.canvas.width && s === this.h.canvas.height) ||
          ((this.h.canvas.width = o), (this.h.canvas.height = s));
        const [u, a] = [o, s];
      ...
      f(this, r, (i) => {
        f(this, t, (o) => {
          ...
          this.h.HEAPU8.set(e, s),
            this.h._addProtoToInputStream(s, e.length, o, i, n),
            this.h._free(s);
        });
      });
    }
    ...
    addProtoToInputSidePacket(e, t, r) {
      f(this, r, (n) => {
        f(this, t, (i) => {
          ...
          this.h.HEAPU8.set(e, o),
            this.h._addProtoToInputSidePacket(o, e.length, i, n),
            this.h._free(o);
        });
      });
    }
...
async function qn(e, t) {
  const r = await (async (n, i, o) => {
    ...
    if (
      (n && (await nr(n)),
      !self.ModuleFactory || (i && (await nr(i), !self.ModuleFactory)))
    )
      throw Error('ModuleFactory not set.');
    return (
      self.Module &&
        o &&
        (((n = self.Module).locateFile = o.locateFile),
        o.mainScriptUrlOrBlob &&
          (n.mainScriptUrlOrBlob = o.mainScriptUrlOrBlob)),
      (o = await self.ModuleFactory(self.Module || o)),
...
function sr(e) {
  try {
    ...
    if (t > 1)
      throw Error(
        'Encountered multiple errors: ' + e.H.map((r) => r.message).join(', ')
      );
  } finally {
    e.H = [];
  }
...
var Zn = class extends w {
  ...
  tn = [
    ...
    [
      0,
      [0, g, -1, B, [0, g, [0, g, -1], -1, [0, z, -1], S], S, -2, g, -1],
      [0, g, -1, S],
      cr,
      S,
      g,
...
const ri = /* @__PURE__ */ (function (e) {
  return class nn extends e {
    static async Y(r, n) {
      ...
      n ||= await nn.O();
      const o = [];
      for (const s of r?.requiredFeatures ?? [])
        n.features.has(s)
          ? o.push(s)
          : console.warn(`WebGPU feature ${s} is not supported.`);
    ...
    return class extends e {
      addStreamingReaderToInputSidePacket(t, r) {
        this.h.addStreamingReaderToInputSidePacket(
          (n, i, o) =>
            (async function (s, u, a, l, c) {
              if (c === 2)
                return (
                  (s.i = []),
                  (s.j = () => Promise.resolve(void 0)),
                  setTimeout(() => {
                    s.l();
                  }, 0),
                  Promise.resolve(0)
              ...
              if (s.size < a + l)
                throw Error(
                  `Data size is too small: ${s.size}, expected at least ${a + l}.`
                );
              h = u._malloc(l) >>> 0;
              let d = 0;
              for (let p = 0; p < s.i.length; p++) {
                ...
                if ((a = Xn(_, a, A, c)) === void 0)
                  throw Error('Data has already been released.');
                if ((u.HEAPU8.set(a, h + d), (a = 0), (d += A), (l -= A) == 0))
                  break;
              }
...
async function Pe() {
  ...
  if (e.limits.maxStorageBufferBindingSize < 524550144)
    throw Error(
      `The WebGPU device is unable to execute LLM tasks, because the required maxStorageBufferBindingSize is at least 524550144 but your device only supports maxStorageBufferBindingSize of ${t}`
    );
  if (t >= 786825216) t = 786825216;
  else {
    if (!(t >= 524550144))
      throw Error(
        `The WebGPU device is unable to execute LLM tasks, because the required maxBufferSize is at least 524550144 but your device only supports maxBufferSize of ${t}`
      );
    t = 524550144;
  }
  t = {
  ...
  const r = e.features.has('chromium-experimental-subgroups'),
    n = e.features.has('subgroups');
  if (r || n) {
    console.warn(
    ...
    n &&
      (i.push('subgroups'),
      e.features.has('subgroups-f16') && i.push('subgroups-f16')),
      r && i.push('chromium-experimental-subgroups'),
      (t.requiredFeatures = i);
  }
  return dt.Y(t, e);
}
function ii(e) {
  const t = (function (n) {
    const i = new Jr();
    m(i, 10, 'text_in'),
      m(i, 10, 'token_cost_in'),
      m(i, 10, 'lora_model_id_to_apply_in'),
      m(i, 10, 'lora_model_ref_in'),
      m(i, 10, 'lora_model_id_to_load_in'),
      m(i, 16, 'streaming_reader'),
      m(i, 15, 'text_out'),
      m(i, 15, 'text_end'),
      m(i, 15, 'token_cost_out');
    var o = new C();
    P(o, 2, 'TokenizerInputBuildCalculator'),
      m(o, 3, 'PROMPT:text_in'),
      m(o, 3, 'LORA_ID:lora_model_id_to_apply_in'),
      m(o, 4, 'prompt'),
      W(i, o),
      P((o = new C()), 2, 'ModelDataCalculator'),
      m(o, 6, 'MODEL_DATA:__side_packet_1'),
      m(o, 6, 'MODEL_TYPE:model_type'),
      m(o, 5, 'READ_DATA_FN:streaming_reader'),
      m(o, 3, 'LORA_MODEL_SPAN:lora_model_ref_in'),
      m(o, 3, 'LORA_MODEL_ID:lora_model_id_to_load_in'),
      m(o, 4, 'LORA_DATA:lora_model_data'),
      W(i, o),
      P((o = new C()), 2, 'Gpt2UnicodeMappingCalculator'),
      m(o, 5, 'MODEL_TYPE:model_type'),
      m(o, 6, 'BYTES_TO_UNICODE_MAPPING:tokenizer_mapping'),
      W(i, o),
      P(
        (o = new re()),
        1,
    ...
    if (
      (D(u, 3, 2),
      rt(o, u.i()),
      P((u = new C()), 2, 'TokenizerCalculator'),
      me(u, 8, re, o),
      m(u, 5, 'MODEL_DATA:__side_packet_1'),
      m(u, 3, 'PROMPT_AND_INPUT_OPTIONS:prompt'),
      m(u, 5, 'BYTES_TO_UNICODE_MAPPING:tokenizer_mapping'),
      m(u, 6, 'PROCESSOR_GETTER:__input_side_1'),
      m(u, 4, 'IDS_AND_INPUT_OPTIONS:__stream_0'),
      W(i, u),
      P(
        (o = new re()),
        1,
      ...
      (4 & c || Object.isFrozen(l)) &&
        ((l = $(l)), (c = te(c, a)), (a = T(h, a, 4, l)));
      let _ = (p = 0);
      for (; p < l.length; p++) {
        const A = ue(l[p]);
        A != null && (l[_++] = A);
    ...
    return (
      d === 1 || (d === 4 && 32 & c)
        ? G(c) || ((a = c), (c |= 2) !== a && v(l, c), Object.freeze(l))
        : ((p = d === 5 && (!!(32 & c) || G(c) || !!Ue?.get(l))),
          (d === 2 || p) &&
            G(c) &&
            ((l = $(l)),
            (c = oe((c = te(c, a)), a, !1)),
      ...
      J(u, 20, s),
      rt(o, u.i()),
      P((s = new C()), 2, 'LlmGpuCalculator'),
      me(s, 8, re, o),
      m(s, 3, 'IDS_AND_INPUT_OPTIONS:__stream_0'),
      m(s, 3, 'FINISH:finish'),
      m(s, 3, 'LORA_DATA:lora_model_data'),
      m(s, 5, 'MODEL_DATA:__side_packet_1'),
      m(s, 4, 'DECODED_IDS:__stream_3'),
      m(s, 4, 'OUTPUT_END:__stream_4'),
      P((o = new Zt()), 1, 'FINISH'),
      F(o, 2, !0, !1),
      me(s, 13, Zt, o),
      W(i, s),
      P((s = new C()), 2, 'IsPacketPresentCalculator'),
      m(s, 3, '__stream_4'),
      m(s, 4, 'text_end'),
      W(i, s),
      P(
      ...
      m(o, 4, '<|endoftext|>'),
      rt(s, o.i()),
      P((n = new C()), 2, 'DetokenizerCalculator'),
      me(n, 8, re, s),
      m(n, 3, 'IDS_AND_INPUT_OPTIONS:__stream_3'),
      m(n, 5, 'PROCESSOR_GETTER:__input_side_1'),
      m(n, 5, 'BYTES_TO_UNICODE_MAPPING:tokenizer_mapping'),
      m(n, 5, 'MODEL_DATA:__side_packet_1'),
      m(n, 4, 'FINISH_AND_INPUT_OPTIONS:finish'),
      m(n, 4, 'WORDS:text_out'),
      W(i, n),
      P((n = new C()), 2, 'TokenCostCalculator'),
      m(n, 3, 'PROMPT:token_cost_in'),
      m(n, 5, 'PROCESSOR_GETTER:__input_side_1'),
      m(n, 5, 'BYTES_TO_UNICODE_MAPPING:tokenizer_mapping'),
      m(n, 4, 'NUM_TOKENS:token_cost_out'),
      W(i, n),
      i
    );
  })(e);
...
`
      ...
      e.v && e.A.length === 0 && (e.F ? e.v(n, !1) : e.v(n[0], !1)),
      de(e, i);
  }),
    ...
    e.i.attachBoolListener('text_end', (n, i) => {
      if (
        ...
        de(e, i),
        pt(e),
        e.o && (e.o.resolve(e.D.map((o) => o.join(''))), (e.o = void 0)),
        e.v)
      )
        if (e.F) {
    ...
    e.i.attachEmptyPacketListener('text_end', (n) => {
      (e.l = !1),
        ...
        de(e, n),
        pt(e),
        e.o && (e.o.resolve(e.D.map((i) => i.join(''))), (e.o = void 0));
    }),
  ...
  const r = t.i();
  return (
    e.u?.removeEventListener('uncapturederror', e.I),
    e.i.S().then(() => {
      e.u?.addEventListener('uncapturederror', e.I),
        (e.A.length = 0),
...
function dr(e, t, r, n) {
  ...
  for (
    e.v = typeof r == 'function' ? r : n, e.l = !0, e.D.length = 0, n = 0;
    n < Q(e.j, 5);
    n++
  )
    e.D[n] = [];
  if (
    ((n = e.G + 1), e.i.addStringToStream(t, 'text_in', n), r instanceof on)
  ) {
    if (r.j !== e)
      throw (
        ((e.l = !1),
...
var E = class extends ht {
  constructor(e, t) {
    if (
      ...
      (this.A = []),
      (this.I = (r) => {
        const n = (r = r.error).message.match(
          /exceeds the max buffer size limit \(([0-9]+)\)\./
        );
        n && Number(n[1]) > 524550144
          ? (r = Error(
              `Failed to run this LLM model, but you could try a smaller LLM model. WebGPU throws: "${r.message}"`
            ))
          : r.message.match(/is larger than the maximum binding size/) &&
            (r = Error(
              `Failed to run LLM inference, the supported max binding size is smaller than the required size. WebGPU throws: "${r.message}"`
            )),
          this.A.push(r);
      }),
      (this.j = new Yn()),
  ...
  K(e) {
    ...
    if (
      ...
      e.baseOptions?.gpuOptions?.device &&
        (this.u && this.u.removeEventListener('uncapturederror', this.I),
        (this.u = e.baseOptions.gpuOptions.device),
        this.i.V(this.u),
        this.u.addEventListener('uncapturederror', this.I)),
      'maxTokens' in e && K(this.j, 2, Ee(e.maxTokens ?? 512)),
      'topK' in e && D(this.s, 2, e.topK ?? 40),
      'temperature' in e && F(this.s, 4, Qe(e.temperature ?? 0.8), 0),
      'randomSeed' in e && K(this.s, 5, at(e.randomSeed ?? 0)),
      'loraRanks' in e &&
        (function (i, o) {
          Gr(i, 4, o);
        })(this.j, e.loraRanks ?? []),
              ...
              return new it(
                ...
                async () => {
                  ...
                  try {
                    ...
                    throw Error(
                      `Error loading model from "${i.toString()}": ${c}`
                    );
                  }
          ...
          : e.baseOptions.modelAssetBuffer instanceof Uint8Array
            ...
            : e.baseOptions.modelAssetBuffer
              ? ((this.J = (function (i, o) {
                ...
                (r = !0))
              : n(),
        r && (e.baseOptions.modelAssetBuffer = void 0);
    }
    return (
      (e = ii(this).then(() => {})),
  ...
  Z(e) {
    ...
    return (
      (this.l = !0),
      (this.N = void 0),
      this.i.addStringToStream(e, 'token_cost_in', this.G + 1),
  ...
  async W(e) {
      ...
      e = await (async function (r, n) {
        ...
        if (n !== o)
          throw (
            (ur(r),
            Error(
              `File could not be fully loaded to memory, so was not retained. Loaded ${o}/${n} bytes before failure`
            ))
          );
        return r;
      })(this.i.h, e);
    return (
      (t = new on(this)),
      this.i.R(e, this.G + 1),
      this.i.addUintToStream(t.i, 'lora_model_id_to_load_in', this.G + 1),
      this.finishProcessing(),
      ur(e),
      (this.l = !1),
      t
...
(E.prototype.loadLoraModel = E.prototype.W),
  (E.prototype.sizeInTokens = E.prototype.Z),
  (E.prototype.generateResponses = E.prototype.U),
  (E.prototype.generateResponse = E.prototype.T),
  (E.prototype.setOptions = E.prototype.K),
  (E.createWebGpuDevice = Pe),
  (E.createFromModelPath = async function (e, t) {
    return nt(
      e,
      (t = {
        baseOptions: { gpuOptions: { device: await Pe() }, modelAssetPath: t },
      })
    );
  }),
...
var ui = async (e = [{}]) => {
    ...
    const t = [];
    e.forEach((i, o) => {
      (t[o] = { description: i.description || 'Files', accept: {} }),
        i.mimeTypes
          ? i.mimeTypes.map((s) => {
    ...
    for (
      var l,
        c = (function (h) {
          ...
          for (
            typeof Symbol < 'u' &&
            ((p = Symbol.asyncIterator), (_ = Symbol.iterator));
            A--;
      ...
      h.kind === 'file'
        ...
        : h.kind !== 'directory' || !t || (n && n(h)) || i.push(sn(h, t, d, n));
    }
  } catch (h) {
    (a = !0), (s = h);
  } finally {
...
var ci = async (e = {}) => {
    ...
    return (await (await t.values()).next()).done
      ? [t]
      : sn(t, e.recursive, void 0, e.skipDirectory);
  },
  hi = { __proto__: null, default: ci },
  fi = async (e, t = [{}], r = null, n = !1, i = null) => {
    Array.isArray(t) || (t = [t]),
    ...
    if (
      ...
      t.forEach((l, c) => {
        (o[c] = { description: l.description || 'Files', accept: {} }),
          l.mimeTypes
            ? (c === 0 && s && l.mimeTypes.push(s),
              l.mimeTypes.map((h) => {
                o[c].accept[h] = l.extensions || [];
              }))
            : s
              ? (o[c].accept[s] = l.extensions || [])
              : (o[c].accept['*/*'] = l.extensions || []);
      }),
      r)
    )
      try {
    ...
    return 'stream' in e
      ? (await e.stream().pipeTo(a), u)
      : 'body' in e
        ? (await e.body.pipeTo(a), u)
        : (await a.write(await e), await a.close(), u);
  },
  di = { __proto__: null, default: fi },
  pi = async (e = [{}]) => (
    Array.isArray(e) || (e = [e]),
    new Promise((t, r) => {
      ...
      const i = [
        ...e.map((a) => a.mimeTypes || []),
        ...e.map((a) => a.extensions || []),
      ].join();
      (n.multiple = e[0].multiple || !1),
        (n.accept = i || ''),
      ...
      const o = (a) => {
        ...
        s = e[0].legacySetup && e[0].legacySetup(o, () => s(r), n),
        u = () => {
      ...
      n.addEventListener('click', () => {
        ...
        n.addEventListener('change', () => {
          window.removeEventListener('focus', u),
            n.remove(),
            o(n.multiple ? Array.from(n.files) : n.files[0]);
        }),
        'showPicker' in HTMLInputElement.prototype ? n.showPicker() : n.click();
    })
  ),
  mi = { __proto__: null, default: pi },
  gi = async (e = [{}]) => (
    Array.isArray(e) || (e = [e]),
          ...
          ? e[0].recursive &&
            ...
            (s = s.filter((u) =>
              u.webkitRelativePath
                .split('/')
                .every(
                  (a) => !e[0].skipDirectory({ name: a, kind: 'directory' })
                )
            ))
          : (s = s.filter((u) => u.webkitRelativePath.split('/').length === 2)),
          i(s);
      }),
        'showPicker' in HTMLInputElement.prototype ? n.showPicker() : n.click();
    })
  ),
  _i = { __proto__: null, default: gi },
  yi = async (e, t = {}) => {
    Array.isArray(t) && (t = t[0]);
    const r = document.createElement('a');
    let n = e;
    'body' in e &&
      (n = await (async function (s, u) {
        const a = s.getReader(),
      ...
      (r.download = t.fileName || 'Untitled'),
      (r.href = URL.createObjectURL(await n));
    const i = () => {
        typeof o == 'function' && o();
      },
...
let an,
  ...
  mr = 0;
const bi = async (e) => {
    (pr === e.temperature && mr === e.topK) ||
      ((pr = e.temperature),
      (mr = e.topK),
      (ln = await E.createFromOptions(un, {
        baseOptions: {
          modelAssetPath: an,
        },
        topK: e.topK,
  ...
  Ve = async () => {
    document.removeEventListener('click', Ve, { once: !0 }),
      document.removeEventListener('keydown', Ve, { once: !0 });
    const e = await si({
      extensions: ['.bin'],
